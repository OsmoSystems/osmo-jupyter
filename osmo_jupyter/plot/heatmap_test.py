...
class TestCutArray2D:
    def test_cut_odd_shape(self):
        ...
        actual_block_centers, actual_blocks = module.cut_array2d(odd_array, block_shape=(3, 3))
    ...
    def test_cut_even_shape(self):
        ...
        actual_block_centers, actual_blocks = module.cut_array2d(even_array, block_shape=(2, 2))
    ...
    def test_mismatch_shape_drops_edges(self):
        ...
        actual_block_centers, actual_blocks = module.cut_array2d(mismatch_shaped_array, block_shape=(2, 2))
    ...
    def test_returns_nothing_if_block_size_larger_than_array(self):
        ...
        actual_block_centers, actual_blocks = module.cut_array2d(small_array, block_shape=(3, 3))
...
class TestGetBlockMeans2D:
    ...
    @pytest.mark.parametrize('name,block_centers,blocks', [
