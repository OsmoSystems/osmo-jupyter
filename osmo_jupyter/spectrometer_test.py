...
class TestImportSpectrometerData:
    def test_import_spectrometer_txt(self):
        test_data_file_path = pkg_resources.resource_filename(
            "osmo_jupyter", "test_fixtures/mock_spectrometer_data.txt"
        )
    ...
    def test_broken_spectrometer_file(self):
        test_data_file_path = pkg_resources.resource_filename(
            "osmo_jupyter", "test_fixtures/mock_bad_spectrometer_data.txt"
        )
...
def test_spectrometer_intensity_summary(
    ...
    actual = module.spectrometer_intensity_summary(
        FORMATTED_SPECTROMETER_DF, **intensity_summary_kwargs
    )
