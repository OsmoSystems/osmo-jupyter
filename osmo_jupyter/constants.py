...
STANDARD_MG_PER_L_PER_MMHG = (
    DO_SATURATION_AT_SEA_LEVEL_MG_PER_L / DO_PARTIAL_PRESSURE_MMHG_AT_1ATM
)
...
DO_STANDARD_OPERATING_MIN_MMHG = (
    DO_STANDARD_OPERATING_MIN_MG_PER_L / STANDARD_MG_PER_L_PER_MMHG
)
DO_STANDARD_OPERATING_MAX_MMHG = (
    DO_STANDARD_OPERATING_MAX_MG_PER_L / STANDARD_MG_PER_L_PER_MMHG
)
...
COLORS_BY_LETTER = {"r": "red", "g": "green", "b": "blue"}
