...
DO_STANDARD_OPERATING_MIN_PERCENT_SAT = (
    DO_STANDARD_OPERATING_MIN_MG_PER_L / DO_SATURATION_AT_SEA_LEVEL_MG_PER_L * 100
)
DO_STANDARD_OPERATING_MAX_PERCENT_SAT = (
    DO_STANDARD_OPERATING_MAX_MG_PER_L / DO_SATURATION_AT_SEA_LEVEL_MG_PER_L * 100
)
