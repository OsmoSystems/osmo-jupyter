...
class TestPrepCalibrationData:
    def test_combines_ysi_and_camera_data_appropriately(
        self, ysi_data_filepath, image_data_filepath
    ):
        calibration_data = module.prep_calibration_data(
            ysi_data_filepath, image_data_filepath, "DO patch", "Reference patch"
        )
